# source MDOF_elcentro_Froude.tcl
# El Centro 
...
# first version i put the massen on top so 64mm
#            x node 4 
#            |   
#            |
#            x node 3 
...
# --- Recorders ---
# recorder Node -file data_MODF_Froude/FstoryNode2_disp_L07.txt -time -node 2 -dof 1 2 3 disp
# recorder Node -file data_MODF_Froude/FstoryNode3_disp_L07.txt -time -node 3 -dof 1 2 3 disp
# recorder Node -file data_MODF_Froude/FstoryNode4_disp_L07.txt -time -node 4 -dof 1 2 3 disp
...
recorder Node -file data_MODF_Froude/Fvelocity_L07.txt -time -nodeRange 2 4 -dof 1 2 3 vel
recorder Node -file data_MODF_Froude/Fbase_shear07.txt -time -node 1 -dof 1 reaction

# --- GRAVITY load ---
# load is not written for this script
#  20 kg * 9.81 on node 2
set G 9.81
timeSeries Linear 1
pattern Plain 1 1 {
