...
# source SDOF_elcentro_Cauchy.tcl
# VERSION v7.5 EL Centro
# Streetlight Model with Similitude
# same Material E, rho
# damping \zeta should be 2% 

wipe;
model basic -ndm 2 -ndf 3;
file mkdir data_SDOF_Cauchy;
...
set Ts [expr $Ls]; 
set Accs [expr $Ls**(-1)]; # set acceleration scale L^{-1}
...
# --- Recorders ---
recorder Node -file data_SDOF_Cauchy/Node2_disp_L07.txt -time -node 2 -dof 1 2 3 disp
#recorder Node -file data_SDOF_Cauchy/Node2_acc_L1.txt -time -node 2 -dof 1 accel
