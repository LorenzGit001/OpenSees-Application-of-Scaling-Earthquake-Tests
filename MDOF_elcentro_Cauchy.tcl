# source MDOF_elcentro_Cauchy.tcl
# Gomes et. al replica simple case canrtilever
# El Centro 
...
file mkdir data_MODF_Cauchy;

# --- Scale factors Froude similtude ---
set Ls 1     ;# length scale (e.g. 1/100)
...
mass 2 [expr 1.12e-01*$Ms]  0.0 0.0
mass 3 [expr 1.12e-01*$Ms]  0.0 0.0
mass 4 [expr 1.12e-01*$Ms]  0.0 0.0
...
set A  [expr $A0*$As]
set Iz [expr $Iz0*$Is]
set E  [expr $E0*$Es]; #does not change 
...
# set numElems 3
# --- Recorders ---
# recorder Node -file data_MODF_Cauchy/storyNode1_disp_L1.txt -time -node 1 -dof 1 2 3 disp
#recorder Node -file data_MODF_Cauchy/storyNode2_disp_L07.txt -time -node 2 -dof 1 2 3 disp
#recorder Node -file data_MODF_Cauchy/storyNode3_disp_L07.txt -time -node 3 -dof 1 2 3 disp
#recorder Node -file data_MODF_Cauchy/storyNode4_disp_L07.txt -time -node 4 -dof 1 2 3 disp
# recorder Node -file data_MODF_Cauchy/disp_L07.txt -time -nodeRange 1 3 -dof 1 2 3 disp
# recorder Node -file data_MODF_Cauchy/velocity_L1.txt -time -nodeRange 2 4 -dof 1 2 3 vel
# recorder Node -file data_MODF_Cauchy/Gomes_10th_dispNode4_TOG.txt -time -node 4 -dof 1 2 3 disp
...
# recorder Node -file data_MODF_Cauchy/base_shear1.txt -time -node 1 -dof 1 reaction
recorder Element -file data_MODF_Cauchy/ele1_forceL1.txt -time -ele 1 force

recorder Element -file data_MODF_Cauchy/ele1_defo1L1.txt -time -ele 1 section 1 deformation
recorder Element -file data_MODF_Cauchy/ele1_defo2L1.txt -time -ele 1 section 1 basicDeformation

# --- GRAVITY load ---
# load is not written for this script
#   kg * 9.81
set G [expr 9.81*$Accs]
timeSeries Linear 1
pattern Plain 1 1 {
